...
// import EmailStrategyBuilder from "./components/email-marketing/EmailStrategyBuilder";
// import AnalyticsOverview from "./components/AnalyticsOverview";
// import SettingsPage from "./components/SettingsPage";
// import LandingPageBuilder from "./components/LandingPageBuilder";
// import PricingPage from "./components/PricingPage";
// import WhatsAppGoalSelector from "./components/whatsapp-marketing/WhatsappGoalSelector";
// import WhatsAppStrategyBuilder from "./components/whatsapp-marketing/WhatsappStrategyBuilder";
// import WhatsAppDashboard from "./components/whatsapp-marketing/WhatsappDashboard";
...
// type AITool = "landing-page" | "email" | "sms-whatsapp";
...
//   const [specificTool, setSpecificTool] = useState<AITool | null>(null);
//   const [userName, setUserName] = useState("");
//   const [selectedEmailGoal, setSelectedEmailGoal] = useState<string | null>(
//     null
//   );
//   const [selectedWhatsAppGoal, setSelectedWhatsAppGoal] = useState<
//     string | null
//   >(null);
...
//   const handleAIToolClick = (tool: AITool, goal?: string): void => {
//     setSpecificTool(tool);

//     if (tool === "email" && goal) {
//       setSelectedEmailGoal(goal);
//       setCurrentView("email-campaign-builder");
//       return;
//     }

//     if (tool === "sms-whatsapp") {
//       setCurrentView("whatsapp-goal-selector");
//       return;
//     }
...
//   const handleWhatsAppGoalSelect = (goal: string): void => {
//     setSelectedWhatsAppGoal(goal);
//     setCurrentView("whatsapp-strategy-builder");
//   };

//   const handleWhatsAppStrategyComplete = (strategy: unknown): void => {
//     console.log("WhatsApp strategy completed:", strategy);
//     setCurrentView("whatsapp-dashboard");
//   };
...
//   const handleLandingPageBuilder = (): void => {
//     setCurrentView("landing-page-builder");
//   };

//   const handleEmailCampaignBuilder = (): void => {
//     setCurrentView("email-campaign-builder");
//   };

//   // AI Campaign Builder → AI Prompt Builder (no specific tool)
//   const handleAICampaignBuilder = (): void => {
//     setSpecificTool(null);
//     setCurrentView("ai-builder");
//   };
...
//       case "email-strategy-builder":
//         return (
//           <EmailStrategyBuilder
//             goal={selectedEmailGoal}
//             onBack={handleBackFromAI}
//           />
//         );
...
//           <EmailMarketing
//             onBack={() => setCurrentView("dashboard")}
//             onOpenAIBuilder={(goal) => handleAIToolClick("email", goal)}
//           />
//         );

//       case "whatsapp-goal-selector":
//         return (
//           <WhatsAppGoalSelector
//             onBack={handleBackFromAI}
//             onSelectGoal={handleWhatsAppGoalSelect}
//           />
//         );

//       case "whatsapp-strategy-builder":
//         return (
//           <WhatsAppStrategyBuilder
//             goal={selectedWhatsAppGoal || ""}
//             onBack={() => setCurrentView("whatsapp-goal-selector")}
//             onComplete={handleWhatsAppStrategyComplete}
//           />
//         );
...
//           <WhatsAppDashboard
//             onBack={() => setCurrentView("dashboard")}
//             onCreateNew={() => setCurrentView("whatsapp-goal-selector")}
//           />
//         );
...
//                   onClick={handleEmailCampaignBuilder}
//                 >
//                   <CardHeader className="text-center">
...
>>>>>>> 31ab30e (update)
  const [specificTool, setSpecificTool] = useState<
    "landing-page" | "email" | "sms-whatsapp" | "email-strategy-builder" | null
  >(null);
  const [selectedEmailGoal, setSelectedEmailGoal] = useState<string>("");
  const [selectedWhatsAppGoal, setSelectedWhatsAppGoal] = useState<string>("");
...
>>>>>>> 31ab30e (update)
  ...
  const handleAIToolClick = (
    tool: "landing-page" | "sms-whatsapp" | "email" | null,
    goal?: string
  ) => {
    setSpecificTool(tool);
    if (tool === "email" && goal) {
  ...
  const handleWhatsAppGoalSelect = (goal: string) => {
    setSelectedWhatsAppGoal(goal);
    setCurrentView("whatsapp-strategy-builder");
  };

  const handleEmailGoalSelect = (goal: string) => {
    setSelectedEmailGoal(goal);
    setCurrentView("email-strategy-builder");
  };

  const handleWhatsAppStrategyComplete = (strategy: unknown) => {
    console.log("WhatsApp strategy completed:", strategy);
    setCurrentView("sms-whatsapp");
  };

  const handleEmailStrategyComplete = (strategy: unknown) => {
    console.log("Email strategy completed:", strategy);
    ...
    switch (currentView) {
      ...
      case "email":
        return (
          <EmailMarketing
            onBack={() => setCurrentView("dashboard")}
            onCreateNew={() => setCurrentView("email-strategy-builder")}
          />
        );
      case "email-goal-selector":
        return (
          <EmailGoalSelector
            onBack={handleBackFromAI}
            onSelectGoal={handleEmailGoalSelect}
          />
        );
      case "email-strategy-builder":
        return (
          <EmailStrategyBuilder
            goal={selectedEmailGoal}
            onComplete={handleEmailStrategyComplete}
            onBack={() => setCurrentView("email-goal-selector")}
          />
        );
      case "sms-whatsapp":
        return (
...
=======
        return (
          <SettingsPage
            onViewChange={() => setCurrentView("pricing")}
            onBack={() => setCurrentView("dashboard")}
          />
        );
>>>>>>> 31ab30e (update)
